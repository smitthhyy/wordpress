...
/******/ 	return __webpack_require__(__webpack_require__.s = "./blocks/categories/src/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./assets/jsx/adverts-list-data.js":
/*!*****************************************!*\
  !*** ./assets/jsx/adverts-list-data.js ***!
  \*****************************************/
/*! exports provided: default */
...
var AdvertsListData = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(AdvertsListData, _Component);

  var _super = _createSuper(AdvertsListData);

  function AdvertsListData(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, AdvertsListData);

    _this = _super.call(this, props);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChange", function (e) {
      if (e.target.value == "-1") {
        return;
      }

      _this.addOption(e.target.value);

      _this.props.onChange(_this.data.options);

      e.target.value = "-1";
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onCustomizeQuery", function (e) {});

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onMove", function (old_index, new_index) {
      _this.data.options = _this.arrayMove(_this.data.options, old_index, new_index);

      _this.props.onChange(_this.data.options);
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onTrashClick", function (remove_index) {
      _this.data.options.splice(remove_index, 1);

      _this.props.onChange(_this.data.options);
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getOptionLabel", function (name) {
      for (var j = 0; j < _this.props.data.builtin.data.length; j++) {
        if (_this.props.data.builtin.data[j].name === name) {
          return _this.props.data.builtin.data[j].label;
        }
      }

      for (var i = 0; i < _this.props.data.length; i++) {
        for (var j = 0; j < _this.props.data[i].data.length; j++) {
          if (_this.props.data[i].data[j].name === name) {
            return _this.props.data[i].data[j].label;
          }
        }
      }
    ...
    _this.data.options = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.value);
    _this.state = {
      mode: "normal"
    };
    return _this;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(AdvertsListData, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["BaseControl"], {
        label: "List Data",
        labelPosition: "top"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("select", {
        className: "components-select-control__input",
        onChange: this.onChange
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("option", {
        key: "-1",
        value: "-1"
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("optgroup", {
        label: this.props.data.builtin.label
      }, this.props.data.builtin.data.map(function (object, i) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("option", {
          key: i,
          value: object.name
        }, object.label);
      })), this.props.data.meta.data.length > 0 && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("optgroup", {
        label: this.props.data.meta.label
      }, this.props.data.meta.data.map(function (object, i) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("option", {
          key: i,
          value: object.name
        }, object.label);
      })), this.props.data.taxonomies.data.length > 0 && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("optgroup", {
        label: this.props.data.taxonomies.label
      }, this.props.data.taxonomies.data.map(function (object, i) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("option", {
          key: i,
          value: object.name
        }, object.label);
      }))), options.length > 0 && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, options.map(function (object, i) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Flex"], {
          key: i
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["FlexBlock"], {
          title: _this2.getOptionLabel(object.name),
          style: {
            textOverflow: "ellipsis",
            overflow: "hidden",
            whiteSpace: "nowrap"
          }
        }, _this2.getOptionLabel(object.name)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["FlexItem"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Button"], {
          label: "",
          variant: "trynitary",
          ...
          onClick: function onClick(e) {
            return _this2.onMove(i, i + 1, object);
          },
  ...
  return AdvertsListData;
}(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (AdvertsListData);

/***/ }),

/***/ "./assets/jsx/adverts-select.js":
/*!**************************************!*\
  !*** ./assets/jsx/adverts-select.js ***!
  \**************************************/
/*! exports provided: default */
...
var AdvertsSelect = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(AdvertsSelect, _Component);

  var _super = _createSuper(AdvertsSelect);

  function AdvertsSelect(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, AdvertsSelect);

    _this = _super.call(this, props);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this), "getOptionLabel", function (name) {
      for (var j = 0; j < _this.props.data.builtin.data.length; j++) {
        if (_this.props.data.builtin.data[j].name === name) {
          return _this.props.data.builtin.data[j].label;
        }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(AdvertsSelect, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          label = _this$props.label,
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["BaseControl"], {
        ...
        key: "-1",
        value: "-1"
      }), this.props.options.map(function (object, i, value) {
        if (object.options.length === 0) {
          return null;
        }

        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("optgroup", {
          key: i,
          label: object.label
        }, object.options.map(function (option, j) {
...
/* harmony default export */ __webpack_exports__["default"] = (AdvertsSelect);

/***/ }),

/***/ "./blocks/categories/src/block.json":
/*!******************************************!*\
  !*** ./blocks/categories/src/block.json ***!
  \******************************************/
/*! exports provided: name, apiVersion, textdomain, title, icon, category, editor_style, editor_script, example, attributes, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"wpadverts/categories\",\"apiVersion\":1,\"textdomain\":\"wpadverts\",\"title\":\"Classifieds Categories\",\"icon\":\"megaphone\",\"category\":\"wpadverts\",\"editor_style\":\"wpadverts-blocks-categories\",\"editor_script\":\"block-wpadverts-categories\",\"example\":{},\"attributes\":{\"post_type\":{\"type\":\"string\",\"default\":\"\"},\"taxonomy\":{\"type\":\"string\",\"default\":\"\"},\"columns\":{\"type\":\"integer\",\"default\":4},\"columns_mobile\":{\"type\":\"integer\",\"default\":2},\"item_display\":{\"type\":\"string\",\"default\":\"wpa-item-stacked\"},\"item_padding\":{\"type\":\"integer\",\"default\":3},\"show_icons\":{\"type\":\"boolean\",\"default\":true},\"show_count\":{\"type\":\"boolean\",\"default\":true},\"default_icon\":{\"type\":\"string\",\"default\":\"fas fa-folder\"},\"icon_size\":{\"type\":\"integer\",\"default\":9},\"margin\":{\"type\":\"integer\",\"default\":2},\"color_icon\":{\"type\":\"string\",\"default\":\"#dc2626\"},\"color_text\":{\"type\":\"string\",\"default\":\"#000000\"},\"color_bg\":{\"type\":\"string\",\"default\":\"#f3f4f6\"},\"color_border\":{\"type\":\"string\",\"default\":\"#e5e7eb\"}}}");

/***/ }),

/***/ "./blocks/categories/src/edit.js":
/*!***************************************!*\
  !*** ./blocks/categories/src/edit.js ***!
  \***************************************/
/*! exports provided: default */
...
/* harmony import */ var _assets_jsx_adverts_select__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../assets/jsx/adverts-select */ "./assets/jsx/adverts-select.js");
/* harmony import */ var _assets_jsx_adverts_list_data__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../assets/jsx/adverts-list-data */ "./assets/jsx/adverts-list-data.js");
/* harmony import */ var _assets_jsx_adverts_color_picker__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../assets/jsx/adverts-color-picker */ "./assets/jsx/adverts-color-picker.js");
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit(props) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onSelectTaxonomy", function (taxonomy) {
      _this.props.setAttributes({
        taxonomy: taxonomy
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onCustomizeQuery", function (param, value) {
      var query = _objectSpread({}, _this.props.attributes.query);
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getQueryParam", function (param) {
      if (typeof _this.props.attributes.query[param] === 'undefined') {
        return "";
      } else {
        return _this.props.attributes.query[param];
      }
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getAvailableTaxonomies", function () {
      var types = [{
        label: "",
        value: ""
      }];
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getAvailableItemDisplays", function () {
      return [{
        label: "Stacked",
        value: "wpa-item-stacked"
      }, {
        label: "Aligned",
        value: "wpa-item-aligned"
      }];
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "initVisuals", function () {
      var taxonomy = _this.props.attributes.taxonomy;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "resetVisuals", function () {
      _this.props.setAttributes({
        taxonomy: ""
      });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowResultsCounter", function (show_results_counter) {
      _this.props.setAttributes({
        show_results_counter: show_results_counter
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleSwitchViews", function (switch_views) {
      _this.props.setAttributes({
        switch_views: switch_views
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleAllowSorting", function (allow_sorting) {
      _this.props.setAttributes({
        allow_sorting: allow_sorting
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowPagination", function (show_pagination) {
      _this.props.setAttributes({
        show_pagination: show_pagination
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangePostsPerPage", function (posts_per_page) {
      _this.props.setAttributes({
        posts_per_page: posts_per_page
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeDisplay", function (display) {
      _this.props.setAttributes({
        display: display
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeDefaultImageUrl", function (default_image_url) {
      _this.props.setAttributes({
        default_image_url: default_image_url
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowPriceColumn", function (show_price_column) {
      _this.props.setAttributes({
        show_price_column: show_price_column
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowImageColumn", function (show_image_column) {
      _this.props.setAttributes({
        show_image_column: show_image_column
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeOrderBy", function (order_by) {
      _this.props.setAttributes({
        order_by: order_by
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeOrderByFeatured", function (order_by_featured) {
      _this.props.setAttributes({
        order_by_featured: order_by_featured
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeListType", function (list_type) {
      _this.props.setAttributes({
        list_type: list_type
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onListDataChange", function (data) {
      console.log(data);
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeTitleSource", function (title_source) {
      _this.props.setAttributes({
        title_source: title_source
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeAltSource", function (alt_source) {
      _this.props.setAttributes({
        alt_source: alt_source
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeListImageWidth", function (list_img_width) {
      _this.props.setAttributes({
        list_img_width: list_img_width
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeListImageHeight", function (list_img_height) {
      _this.props.setAttributes({
        list_img_height: list_img_height
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeListImageFit", function (list_img_fit) {
      _this.props.setAttributes({
        list_img_fit: list_img_fit
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeListImageSource", function (list_img_source) {
      _this.props.setAttributes({
        list_img_source: list_img_source
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeGridColumns", function (grid_columns) {
      _this.props.setAttributes({
        grid_columns: grid_columns
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeGridColumnsMobile", function (grid_columns_mobile) {
      _this.props.setAttributes({
        grid_columns_mobile: grid_columns_mobile
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeGridImgHeight", function (grid_img_height) {
      _this.props.setAttributes({
        grid_img_height: grid_img_height
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeGridImgFit", function (grid_img_fit) {
      _this.props.setAttributes({
        grid_img_fit: grid_img_fit
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeGridImgSource", function (grid_img_source) {
      _this.props.setAttributes({
        grid_img_source: grid_img_source
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColorIcon", function (color_icon) {
      _this.props.setAttributes({
        color_icon: color_icon
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColorText", function (color_text) {
      _this.props.setAttributes({
        color_text: color_text
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColorBg", function (color_bg) {
      _this.props.setAttributes({
        color_bg: color_bg
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColorBorder", function (color_border) {
      _this.props.setAttributes({
        color_border: color_border
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowCount", function (show_count) {
      _this.props.setAttributes({
        show_count: show_count
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "toggleShowIcons", function (show_icons) {
      _this.props.setAttributes({
        show_icons: show_icons
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColumns", function (columns) {
      _this.props.setAttributes({
        columns: parseInt(columns)
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColumnsMobile", function (columns_mobile) {
      _this.props.setAttributes({
        columns_mobile: parseInt(columns_mobile)
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeDefaultIcon", function (default_icon) {
      _this.props.setAttributes({
        default_icon: default_icon
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeIconSize", function (icon_size) {
      _this.props.setAttributes({
        icon_size: icon_size
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onSelectItemDisplay", function (item_display) {
      _this.props.setAttributes({
        item_display: item_display
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeMargin", function (margin) {
      _this.props.setAttributes({
        margin: margin
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeItemPadding", function (item_padding) {
      _this.props.setAttributes({
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Edit, [{
    ...
    value: function runApiFetchForms() {
      ...
      wp.apiFetch({
        ...
        _this2.setState({
          ...
          loading: false,
          initiated: _this2.props.attributes.taxonomy !== ""
        });
      });
    }
  }, {
    ...
    value: function renderInit() {
      ...
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Button"], {
        variant: "primary",
        disabled: taxonomy === "",
    ...
    value: function render() {
      ...
      var taxonomy = attributes.taxonomy,
          item_display = attributes.item_display,
          item_padding = attributes.item_padding,
          columns = attributes.columns,
          columns_mobile = attributes.columns_mobile,
          default_icon = attributes.default_icon,
          icon_size = attributes.icon_size,
          show_icons = attributes.show_icons,
          show_count = attributes.show_count,
          color_icon = attributes.color_icon,
          color_text = attributes.color_text,
          color_bg = attributes.color_bg,
          color_border = attributes.color_border,
          margin = attributes.margin;
      console.log("cats...");
      console.log(columns);
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, this.state.initiated === true ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["PanelBody"], {
        ...
        title: "Colors",
        initialOpen: false
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_assets_jsx_adverts_color_picker__WEBPACK_IMPORTED_MODULE_16__["default"], {
        label: "Icon Color",
        labelPosition: "top",
        value: color_icon,
      ...
      }))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["BlockControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Toolbar"], {
        controls: [{
          icon: "controls-repeat",
          title: "Reset post type and form scheme",
          onClick: this.resetVisuals
        }]
      })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Disabled"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_13___default.a, {
        block: "wpadverts/categories",
        attributes: this.props.attributes
      }))) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, this.renderInit()));
    }
  }]);
...
/***/ "./blocks/categories/src/index.js":
/*!****************************************!*\
  !*** ./blocks/categories/src/index.js ***!
  \****************************************/
/*! no exports provided */
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./blocks/categories/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./blocks/categories/src/block.json");
var _block_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./block.json */ "./blocks/categories/src/block.json", 1);
