...
/******/ 	return __webpack_require__(__webpack_require__.s = "./blocks/details/src/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = JSON.parse("{\"name\":\"wpadverts/details\",\"textdomain\":\"wpadverts\",\"apiVersion\":1,\"title\":\"Classifieds Details\",\"icon\":\"megaphone\",\"category\":\"wpadverts\",\"example\":{},\"attributes\":{\"post_type\":{\"type\":\"string\",\"default\":\"\"},\"contact\":{\"type\":\"array\",\"default\":[{\"name\":\"contact-form\"},{\"name\":\"phone-button\"}]},\"phone_reveal\":{\"type\":\"integer\",\"default\":1}}}");

/***/ }),

/***/ "./blocks/details/src/edit.js":
/*!************************************!*\
  !*** ./blocks/details/src/edit.js ***!
  \************************************/
/*! exports provided: default */
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit(props) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onChangeColor", function (color) {
      _this.props.setAttributes({
        color: color
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onFormStyleChange", function (form_style) {
      _this.props.setAttributes({
        form_style: form_style
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onSelectPostType", function (post_type) {
      _this.props.setAttributes({
        post_type: post_type,
        form_scheme: ""
      });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "onSelectFormScheme", function (form_scheme) {
      _this.props.setAttributes({
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getAvailablePostTypes", function () {
      var types = [{
        label: "",
        value: ""
      }];
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getCurrentPostType", function () {
      return _this.state.post_types[0];
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getSelectedFormScheme", function (type) {
      if (_this.props.attributes.form_scheme === "") {
        return null;
      }

      var pt = _this.getCurrentPostType();

      for (var i = 0; i < pt.form_schemes[type].length; i++) {
        if (pt.form_schemes[type][i].name === _this.props.attributes.form_scheme) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getSelectedFormSchemeData", function (type) {
      var fs = _this.getSelectedFormScheme(type);
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "getAvailableSearchForms", function (post_type) {
      var pt = _this.getCurrentPostType();

      return [{
        label: "",
        value: ""
      }].concat(pt["form_schemes"]["search"]);
    });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "initVisuals", function () {
      var post_type = _this.props.attributes.post_type;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Edit, [{
    ...
    value: function renderInit() {
      var post_type = this.props.attributes.post_type;
      var show_instructions = this.state.show_instructions;
    ...
    value: function render() {
      ...
      var show_instructions = this.state.show_instructions;
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, this.state.initiated === true ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["BlockControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Toolbar"], {
        controls: [{
          icon: "controls-repeat",
          title: "Reset post type and form scheme",
          onClick: this.resetVisuals
        }]
      })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["Disabled"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
      ...
      }, "No preview available for this block.")))) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, this.renderInit()));
    }
  }]);
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./blocks/details/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./blocks/details/src/block.json");
var _block_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./block.json */ "./blocks/details/src/block.json", 1);
